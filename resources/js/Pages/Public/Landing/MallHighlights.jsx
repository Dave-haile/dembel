...
// const MallHighlights = ({mall}) => {
//   console.log('mall high', mall)
//   const highlights = [
//     {
...
const MallHighlights = ({ mall }) => {
  // Parse the extra_data JSON from the mall object
  const highlightsData = mall?.extra_data ? JSON.parse(mall.extra_data) : [];
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-100 to-indigo-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            {mall?.title || "Mall Highlights"}
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {mall?.description || "Discover what makes Dembel City Center Mall the premier destination for shopping and entertainment"}
          </p>
        </div>
