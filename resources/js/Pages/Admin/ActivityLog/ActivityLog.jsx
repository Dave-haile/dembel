...
// import { FiFilter, FiX, FiSearch, FiCalendar, FiUser, FiActivity, FiClock } from 'react-icons/fi';
...
//     const renderObjectAsTable = (obj, title = null) => {
...
//                                 <tr key={key}>
//                                     <td className="px-4 py-2 whitespace-nowrap text-sm font-medium text-gray-900 w-1/4">
...
//                 // For created/deleted items
//                 return renderObjectAsTable(parsed);
//             }

//             return 'No changes';
//         } catch (e) {
//             console.error('Error parsing changes:', e);
//             return 'Error displaying changes';
//         }
//     };
...
//                                 <span className="font-medium">{key}:</span> {String(parsed.before[key])} → {String(value)}
//                             </div>
//                         ))}
//                     </div>
//                 );
...
//                                                 </div>
//                                                 <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
//                                                     <dt className="text-sm font-medium text-gray-500">Subject Type</dt>
//                                                     <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
